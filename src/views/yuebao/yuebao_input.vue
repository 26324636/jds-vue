...
export default {
  ...
  data() {
    return {
      ...
      topSelectVal: '',
      topInputVal: '',
      tableData: [{ id: 0, xmbh: '', swzj: '', xmly: '', province: '', city: '', htjzmjdw: '平方米', jzsbnmywcgzlbl_fa: '0', jzsbnmywcgzlbl_kc: '0', jzsbnmywcgzlbl_sgt: '0', jzsbnmywcgzlbl_hqfw: '0' }, { id: 1, xmbh: '', swzj: '', xmly: '', province: '', city: '' }, { id: 2, xmbh: '', swzj: '', xmly: '', province: '', city: '' }, { id: 3, xmbh: '', swzj: '', xmly: '', province: '', city: '' }],
  ...
  created() {
    ...
    this.getCyzy_hq() // 获取
    this.getGhjgbim() // 获取
    this.getZyfzr_jz_kcList() // 获取
    this.getZyfzr_jgList() // 获取
    this.getZyfzr_gpsList() // 获取
    this.getZyfzr_dqList() // 获取
    this.getZyfzr_ntList() // 获取
    this.getZbwhrList() // 获取
  },
  methods: {
    // 处理当前的是在处理哪一行
